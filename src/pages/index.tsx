                  ...
                  <div className="px-6 py-4">
                    <div className="text-center">
                      ...
                      >
                        <a
                          className={
                            'text-black font-bold text-xl text-xl mb-2 text-justify border-b-2 border-white border-dashed hover:border-purple-400 pb-px transition-colors duration-300'
                          }
                        >
                          {post.Page}
                        </a>
